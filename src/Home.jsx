...
function Home() {
  return (
    <div className="font-sans flex flex-col min-h-screen bg-[#F9F5F0]">
      ...
      <section className="flex flex-1 flex-col items-center justify-center text-center px-6 py-20 bg-gradient-to-br from-orange-100 via-yellow-50 to-orange-100">
