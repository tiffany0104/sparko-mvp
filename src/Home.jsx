...
function Home() {
  return (
    <div className="min-h-screen flex flex-col font-sans bg-[#F9F5F0]">
      <header className="flex justify-between items-center p-4 bg-white shadow-sm">
        ...
        <a href="/login" className="bg-orange-400 text-white px-4 py-2 rounded-full font-medium hover:bg-orange-500">Login</a>
      </header>
      <section className="flex flex-col items-center justify-center flex-1 text-center px-6 py-20 bg-gradient-to-br from-orange-100 via-yellow-50 to-orange-100">
      ...
      <section className="p-8 md:p-12 bg-orange-50">
