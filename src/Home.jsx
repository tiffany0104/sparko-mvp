...
function Home() {
  return (
    <div className="font-sans bg-[#F9F5F0]">
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 py-20 bg-gradient-to-br from-orange-100 via-yellow-50 to-orange-100 min-h-screen flex-grow">
